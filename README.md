...
Si en nuestra documentacion necesitamos incluir informacion en modo de lista,un elemento tras otro podemos hacerlo utilizando un punto decimal si las deseamos ordenadas o un guion medio - si solo queremos una viñeta.
**EJEMPLO**
...
Las ligas son utilizadas para vincular elementos o referencias del proyecto dentro del mismo repositorio o fuera de el. Y se maquetan utilizando los corchetes \[ \],inmediatamente despues pondremos la liga 
...
Dado que en el ejemplo pasado usando solo markdown no se puede realizar la fusion de filas debemos  uyilizar el estandar HTML,usando los tags: \<th> para los encabezados, \<tr> para las filas y <td> para las celdas, y en ellos utilizar la propiedad de *colspan* y *rowspan*
